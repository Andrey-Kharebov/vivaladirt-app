...
function PackagesComponent() {
  return (
    <div className={ classes.packagesComponent }>
      <h2>packages</h2>
      <div className={ classes.packagesSection }>
        <div className={ classes.package }>
          <iframe width="360" height="201" src="https://www.youtube.com/embed/cSqbXfMUL1k?controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
          <h3>basic</h3>
        ...
        <div className={ classes.package }>
          <iframe width="360" height="201" src="https://www.youtube.com/embed/KTIad5OZnWY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <h3>basic plus</h3>
        ...
        <div className={ classes.package }>
          <iframe width="360" height="201" src="https://www.youtube.com/embed/z8f7cE0t0TI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <h3>delux</h3>
